...
Shining examples: `github <https://developer.github.com>`_, the `stripe API <https://stripe.com/docs/api>`_ and `docs <https://stripe.com/docs>`_, and `bootstrap-datepicker <http://bootstrap-datepicker.readthedocs.org/en/v1.4.0/>`_.

**End User Documentation**
    
Documentation for the end user consists of guides and tutorials. Markdown,
especially `github flavored markdown <https://help.github.com/articles/github-flavored-markdown/>`_ may be a good choice for small projects. `Restructured Text (reST) 
